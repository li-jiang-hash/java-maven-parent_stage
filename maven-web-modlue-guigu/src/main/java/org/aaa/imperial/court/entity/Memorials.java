package org.aaa.imperial.court.entity;

/**
 * @Author:江Sir
 * @Date:13 2022/08/13 14:43
...
public class Memorials {
    ...
    public Memorials(Integer memorialsId,
                     String memorialsTitle,
                     String memorialsContent,
                     String memorialsContentDigest,
                     Integer memorialsEmp,
                     String memorialsEmpName,
                     String memorialsCreateTime,
                     String feedbackTime,
                     String feedbackContent,
                     Integer memorialsStatus) {
